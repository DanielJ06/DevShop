...
CREATE TABLE IF NOT EXISTS `devshop`.`products_variations` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_prducts_variations_products_idx` (`product_id` ASC),
  CONSTRAINT `fk_prducts_variations_products`
...
-- -----------------------------------------------------
-- Table `devshop`.`products_images`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `devshop`.`products_images` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_products_images_products_variations1_idx` (`product_variations_id` ASC),
  CONSTRAINT `fk_products_images_products_variations1`
